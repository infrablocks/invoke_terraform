...
class Configuration:
    ...
    def create_empty():
        return Configuration(
            init=InitSpecificConfiguration(backend_config={}, reconfigure=False),
            output=OutputSpecificConfiguration(json=False, capture_stdout=False),
            source_directory="",
            variables={},
            workspace=None,
            environment={},
...
type ConfigureFunction[C] = Callable[
    [Context, Arguments, C], None
]
